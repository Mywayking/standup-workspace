...
- Name: write-smoke.spec.ts >> 🎤 Write Page - 精细化冒烟测试（已修复 bug 验证） >> PremiseTab 结果区不存在 button 嵌套 button
- Location: write-smoke.spec.ts:14:7
