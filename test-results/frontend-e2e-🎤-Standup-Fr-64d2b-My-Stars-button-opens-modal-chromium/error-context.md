...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e5]:
      - button "提炼前提 素材 → 前提" [ref=e6] [cursor=pointer]:
        - generic [ref=e7]: 提炼前提
        - generic [ref=e8]: 素材 → 前提
      - button "梗写前提 梗 → 前提" [ref=e9] [cursor=pointer]:
        - generic [ref=e10]: 梗写前提
        - generic [ref=e11]: 梗 → 前提
      - button "找角度 前提 → 角度" [ref=e12] [cursor=pointer]:
        - generic [ref=e13]: 找角度
        - generic [ref=e14]: 前提 → 角度
      - button "改稿 草稿 → 成品" [ref=e15] [cursor=pointer]:
        - generic [ref=e16]: 改稿
        - generic [ref=e17]: 草稿 → 成品
    - generic [ref=e19]:
      - generic [ref=e21]:
        - paragraph [ref=e22]: 创作历史
        - paragraph [ref=e23]: 还没有创作记录，开始一段新创作吧
      - generic [ref=e25]:
        - generic [ref=e27]:
          - heading "提炼前提" [level=2] [ref=e29]
          - paragraph [ref=e30]: 💡 讲一件事、一个经历、一个观察，AI 帮你提炼出可以上台说的喜剧前提。
          - button "📚 素材库" [ref=e33] [cursor=pointer]
          - textbox "输入一段素材： 一件事、一句抱怨、一个观察、一段情绪…… 📝 示例： • 我发现同事离职后，工位像被系统自动回收一样 • 我妈总觉得我写脱口秀不算正经工作 • 成年人最擅长的事，就是把委屈说成体面" [ref=e34]:
            - /placeholder: "输入一段素材：\n一件事、一句抱怨、一个观察、一段情绪……\n\n📝 示例：\n• 我发现同事离职后，工位像被系统自动回收一样\n• 我妈总觉得我写脱口秀不算正经工作\n• 成年人最擅长的事，就是把委屈说成体面"
          - generic [ref=e35]:
            - generic [ref=e37]: 请输入素材
            - button "开始提炼" [disabled] [ref=e38]
        - generic [ref=e40]:
          - generic [ref=e41]:
            - paragraph [ref=e42]: 这个工具做什么？
            - button "✕" [ref=e43] [cursor=pointer]
          - paragraph [ref=e44]:
            - text: 把一段素材、情绪、观察，转化成
            - strong [ref=e45]: 可以上台说
            - text: 的喜剧前提。
          - generic [ref=e46]:
            - generic [ref=e47]:
              - generic [ref=e48]: ✓
              - paragraph [ref=e49]: 识别主题和态度
            - generic [ref=e50]:
              - generic [ref=e51]: ✓
              - paragraph [ref=e52]: 提炼核心矛盾
            - generic [ref=e53]:
              - generic [ref=e54]: ✓
              - paragraph [ref=e55]: 生成 5 个前提候选
            - generic [ref=e56]:
              - generic [ref=e57]: ✓
              - paragraph [ref=e58]: 推荐最优前提
            - generic [ref=e59]:
              - generic [ref=e60]: ✓
              - paragraph [ref=e61]: 给出场景建议
          - paragraph [ref=e63]: 输入素材越具体，提炼的前提越精准
  - alert [ref=e64]
```
